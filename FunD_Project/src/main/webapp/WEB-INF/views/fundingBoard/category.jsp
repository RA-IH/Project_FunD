      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
          ...
          <div class="filter-bar d-flex flex-wrap align-items-center">
            ...
            <!-- <a href="../projectForm" id="boardBtn" name="boardBtn" class="btn board-form-btn pull-right">게시글등록</a> -->
            <button class="size-a-17 bg2 borad-3 f1-s-12 cl0 hov-btn1 trans-03 p-rl-15 m-t-10" onClick="location.href='/fundingBoard/projectForm'">
								글쓰기</button>
            <div>
